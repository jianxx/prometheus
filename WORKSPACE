...
go_repository(
    ...
    sum = "h1:h+xUINuuH/9CwxE7O8mAuW7Aj9E5agfE9jQ3DrJsnA8=",
    version = "v1.40.10",
)
...
go_repository(
    ...
    sum = "h1:EuccMPzxu67cIE95/mrtwQivLv7ETmURi5IUgLNVug8=",
    version = "v55.8.0+incompatible",
)
...
go_repository(
    ...
    sum = "h1:lJEB2TVIkJydFWJMPtdYOPa2Xwib+smZqq/oUZF8/iA=",
    version = "v1.64.2",
)
...
go_repository(
    ...
    sum = "h1:9lYu6axek8LJrVkMVViVirRcpoaCxXX7+sSvmizGVnA=",
    version = "v0.19.28",
)
...
go_repository(
    ...
    sum = "h1:UP+GUfRSErTzM7UtTMt4TjnfXKK3ybrGQasgSOp7vLY=",
    version = "v0.0.0-20210726183535-c50bf4fe5303",
)
...
go_repository(
    ...
    sum = "h1:zzaIh8W2K5M4AkJhPV1z6O4Sp0FOObzXm61NUmFz3Kw=",
    version = "v0.19.0",
)
...
go_repository(
    ...
    sum = "h1:SngrdG2L62qqLsUz85qcPhFZ78rPf8tcD5qjMgs6MME=",
    version = "v1.9.1",
)
...
go_repository(
    ...
    sum = "h1:BwZa5IjREr75J0am7nblP+X5i95Rmp8EEbMI5vkUWdA=",
    version = "v0.2.3",
)
...
go_repository(
    ...
    sum = "h1:T2a0CVGETf7BoWIdZ/TACqmTZAa/ROutcfdUHYiPAQ4=",
    version = "v1.28.0",
)
...
go_repository(
    ...
    sum = "h1:99+t6GtTaIsL+ncz5BpCbkh8Y90rC7qW1Not8MFe0Gw=",
    version = "v0.31.0",
)
...
go_repository(
    ...
    sum = "h1:JrDZalSEMb2/2bqGAhls6ZnvOxbC5jMIu29JV+uWTC0=",
    version = "v0.22.2",
)
...
go_repository(
    ...
    sum = "h1:cblWILbLO8ar+Fj6xdDGr603HRsf8Wu9E9rngJeprZQ=",
    version = "v0.21.3",
)
...
go_repository(
    ...
    sum = "h1:3Ju4nvjCngxxMYby0BimUk+pQHPOQp3eCGChk5kfVII=",
    version = "v0.21.3",
)
...
go_repository(
    ...
    sum = "h1:J9nxZTOmvkInRDCzcSNQmPJbDYN/PjlxXT9Mos3HcLg=",
    version = "v0.21.3",
)
